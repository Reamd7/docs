...
<AccordionGroup>
  <Accordion icon="github" title="Clone your docs locally">
    ...
    [development2（在新发起请求）](https://reamd7.mintlify.app/development)<br/>
    [relative path development（不重新发起请求，只会fetch 对应文档的json数据，点击文档内部渲染）](/development)

    [Abs hashId](https://reamd7.mintlify.app/quickstart#deploy-your-changes)<br/>
    <a href="https://reamd7.mintlify.app/quickstart#deploy-your-changes">Abs hashId</a><br/>
    [relative hashId](#deploy-your-changes)<br/>
    <a href="#deploy-your-changes">relative hashId</a><br/>
