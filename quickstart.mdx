...
<AccordionGroup>
  <Accordion icon="github" title="Clone your docs locally">
    ...
    <a href="https://reamd7.mintlify.app/development">development（在当前窗口重新发起请求）</a><br/>
    <a href="/development">relative path development（在当前窗口重新发起请求）</a><br/>
    [development2（在新窗口发起请求）](https://reamd7.mintlify.app/development)<br/>
    [relative path development（不重新发起请求，只会fetch 对应文档的json数据，点击文档内部渲染）](/development)

    [Abs hashId（在新窗口发起请求）](https://reamd7.mintlify.app/quickstart#deploy-your-changes)<br/>
    <a href="https://reamd7.mintlify.app/quickstart#deploy-your-changes">Abs hashId（浏览器内置能力，不用刷新直接跳转）</a><br/>
    [relative hashId（有bug，虽然能内跳，但是会强制重新渲染当前页面）](#deploy-your-changes)<br/>
    <a href="#deploy-your-changes">relative hashId（浏览器内置能力，不用刷新直接跳转）</a><br/>
